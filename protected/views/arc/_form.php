...
<div class="form">
	...
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
<!--				--><?php //echo $form->textField($model,'id_user', array('class'=>'form-control', 'placeholder'=>'Nama')); ?>
				<?php
					$static = array(
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<?php echo $form->dropDownList($model, 'id_tipe_dokumen', CHtml::listData(TipeDokumen::model()->findAll(), 'id', 'nama_dokumen'), array('class'=>'form-control')); ?>
			</div>
			<div class="row">
				<div class="col-lg-10 col-lg-offset-2">
		...
		<div class="form-group">
			...
			<div class="col-lg-10">
				<?php echo $form->dropDownList($model,'flag', array('false','true'), array('class'=>'form-control', 'style'=>'width: auto;')); ?>
			</div>
			<div class="row">
				<div class="col-lg-10 col-lg-offset-2">
