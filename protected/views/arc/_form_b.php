...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'attachment_link'); ?>
		<?php echo $form->textField($model,'attachment_link',array('size'=>60,'maxlength'=>64)); ?>
		<?php echo $form->error($model,'attachment_link'); ?>
	</div>
