...
<div class="panel panel-default">
    <div class="panel-body">
        <h5>Luas Puso <?php echo $nama_komoditas." (Lahan Total) Kabupaten {$kabupaten}";?> </h5>
...
//        $calendar = cal_info(0)['months'];
        ...
        <script type="text/javascript">
            $("#chart").highcharts({
                title:{
                    text: <?php echo "'Luas Puso ".$nama_komoditas." Per Kecamatan di Kabupaten {$kabupaten} ".$tahun."'"; ?>
                },
                xAxis:{
                    categories: [
