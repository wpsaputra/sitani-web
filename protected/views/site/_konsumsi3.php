<?php
$title = "
Produksi dan konsumsi Padi Palawija Kabupaten Buton menurut Jenis Tanaman (Buton Selatan)
";								
...
array('Beras',4,'-',2, 7437,'Konsumsi beras dan beras ketan'),
array('Jagung',2006,'-',2357,  610,''),
array('Kedelai',0,'-',0,0,''),
array('kacang Tanah',7,'-',11,  23,''),
array('kacang hijau',0,'-',0,  7,''),
array('Ubi Kayu',6205,'-',7869,  442,'Konsumsi ubi basah dan gaplek'),
array('ubi Jalar',805,'-',396,  87,''),
